...
<template>
  <VRow>
    <VCol cols="12" md="8">
      ...
      >
        <template #default="{ item }">
          <div class="w-100">
            ...
            <p class="text-sm">Mobile: {{ item.subtitle }}</p>
            <VDivider />
            <div class="pt-4">
      ...
      <!-- 👉 Add New Address -->
      <VBtn variant="tonal" class="mt-5 mb-8"> Add New Address </VBtn>
        ...
        <template #default="{ item }">
          <div class="d-flex flex-column align-center gap-2 w-100">
            <div class="d-flex justify-end w-100 mb-n3">
              <VChip :color="resolveDeliveryBadgeData[item.value].color" label>
                {{
    ...
    <VCol cols="12" md="4">
      <VCard flat variant="outlined">
        ...
        <!-- 👉 Price details -->
        <VCardText>
          <h6 class="text-base font-weight-medium mb-5">Price Details</h6>
