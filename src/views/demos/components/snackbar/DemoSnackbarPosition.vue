...
<template>
  <div class="demo-space-x">
    ...
    <VSnackbar v-model="isSnackbarEndVisible" location="end center">
    ...
    <VSnackbar v-model="isSnackbarBottomEndVisible" location="bottom end">
    ...
    <VSnackbar v-model="isSnackbarBottomStartVisible" location="bottom start">
    ...
    <VSnackbar v-model="isSnackbarStartVisible" location="start center">
    ...
    <VSnackbar v-model="isSnackbarTopStartVisible" location="top start">
